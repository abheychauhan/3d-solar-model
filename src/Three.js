...
const suntexture = texLoader.load('/8k_sun.jpg');
const moontexture = texLoader.load('/8k_moon.jpg');
const mercurytexture = texLoader.load('/8k_mercury.jpg');
const venustexture = texLoader.load('/8k_venus_surface.jpg');
const earthtexture = texLoader.load('/8k_earth_daymap.jpg');
const earthnighttexture = texLoader.load('/8k_earth_nightmap.jpg');
const earthSpecularMap = texLoader.load('/8k_earth_specular_map.tif');
const marstexture = texLoader.load('/8k_mars.jpg');
const jupitertexture = texLoader.load('/8k_jupiter.jpg');
const saturntexture = texLoader.load('/8k_saturn.jpg');
const ringTexture = texLoader.load('/8k_saturn_ring_alpha.png');

const uranustexture = texLoader.load('/2k_uranus.jpg');
const neptunetexture = texLoader.load('/2k_neptune.jpg');
